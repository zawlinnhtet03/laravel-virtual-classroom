...
-->
    ...
    <main>
        <article>
            ...
            <div class="blog">
                <h1 class="title">How to Ace Exam without Studying</h1>
                <p class="published"><span>Published at - 2023-09-07</span></p>
                <div class="article">



                    <iframe width="560" height="315"
                        src="https://www.youtube.com/embed/f_WuRfuMXQw?autoplay=1&mute=0&si=IigkMNldccq_u_wL"
            ...
            <section class="blogs-section">
                <div class="blog-card">
                    ...
                    <h1 class="blog-title">Student View: How to Use Classifinity</h1>
                    <p class="blog-overview">This is a brief overview of blog post 1. Click below to read more about
                        this
                        exciting topic!</p>
                    <a href="/blog1" class="btn dark">Read</a>
                </div>
                <div class="blog-card">

                    <h1 class="blog-title">Teacher View: How to Use Classifinity</h1>
                    <p class="blog-overview">Here is a summary of blog post 2. It covers fascinating insights and more
                        details
                        inside.</p>
