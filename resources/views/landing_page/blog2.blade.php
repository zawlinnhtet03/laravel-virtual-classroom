...
-->
    <header class="header" data-header>
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                ...
                <div class="wrapper">
                    <a href="/" class="logo">
                        <img src="{{ asset('assets/img/logo3.jpeg') }}" width="162" height="50" alt="EduWeb logo">
                    </a>
    ...
    <main>
        <article>
            ...
            <div class="blog">
                <h1 class="title">Teacher View: How to use Classifinity</h1>
                ...
                <div class="article">
                    ...
                    <br>
                    <img src="{{ asset('assets/img/teacher_dashboard.png') }}" alt="" width="1000px">
                    <br>
                    <br>
                    <br>
